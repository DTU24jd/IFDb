...
async function setFavoritesToCookie(favorites) {
    const cookieStore = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cookies"])();
...
async function GET() {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(favorites);
}
async function POST(request) {
    const { id } = await request.json();
    let favorites = await getFavoritesFromCookie();
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__a0a36b._.js.map